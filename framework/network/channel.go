...
func NewStreamChannel(id string, index int) *StreamChannel {
	...
	sc.Depacketizers[0] = NewDepacketizer(sc) //初始化一个解包器
...
//
//func (sc *StreamChannel) processAudioPacket(group *FecGroup) {
//	switch sc.Level {
...
//}
//
//func (sc *StreamChannel) Decode(packet *FecPacket) error {
